...
const BackEnd: NextPage<CardsProps> = ({ cards }: CardsProps) => {
  ...
  return (
    <>
      ...
      <main className="flexCol">
        ...
        <ul className="space mb-16 hidden md:grid gap-10 grid-cols-2 xl:grid-cols-3 xl: 2xl:grid-cols-4 2xl:gap-14 sm:hidden">
          {filterProjects.map((project) => (
